...
// 
// Updated by Grzegorza Szura - added TTF_DV_DIR
// 
//========================================================================
...
//   DV_DIR /usr/share/fonts/truetype/ttf-dejavu/
//
// WINDOWS:
//   CACHE_DIR $SERVER_TEMP/jpgraph_cache/
//   TTF_DIR   $SERVER_SYSTEMROOT/fonts/
//   MBTTF_DIR $SERVER_SYSTEMROOT/fonts/
//   DV_DIR $SERVER_SYSTEMROOT/fonts/
//
//------------------------------------------------------------------------
// define('CACHE_DIR','/tmp/jpgraph_cache/');
// define('TTF_DIR','/usr/share/fonts/truetype/');
// define('MBTTF_DIR','/usr/share/fonts/truetype/');
// define('DV_DIR','/usr/share/fonts/truetype/ttf-dejavu/');
// define('VERA_DIR','/usr/share/fonts/truetype/ttf-bitstream-vera/');
//define('CACHE_DIR','$SERVER_TEMP/jpgraph_cache/');
//define('TTF_DIR','$SERVER_SYSTEMROOT/fonts/');
//define('MBTTF_DIR','$SERVER_SYSTEMROOT/fonts/');
//define('DV_DIR','$SERVER_SYSTEMROOT/fonts/');
//define('VERA_DIR','$SERVER_SYSTEMROOT/fonts/');
